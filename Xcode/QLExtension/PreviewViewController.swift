...
///     log show --predicate 'subsystem == "com.jethrohemmann.QuickLookProtein.QLExtension"' --info --last 2m
...
private let qlLog = OSLog(subsystem: "com.jethrohemmann.QuickLookProtein.QLExtension",
                          category: "preview")
